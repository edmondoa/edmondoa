...
class PeopleFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'gender' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created_at' => '2020-03-25 21:38:03',
                'updated_at' => '2020-03-25 21:38:03',
            ],
        ];
        parent::init();
    }
